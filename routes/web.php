...
Route::get('/syarat','user\WelcomeController@about')->name('about');
...
Route::group(['middleware' => ['auth','checkRole:admin']],function(){    
    ...
    Route::get('/admin/export', 'admin\MonthlyReportController@index')->name('admin.export');;
    Route::get('/admin/exportPDF', 'admin\MonthlyReportController@exportPDF');
});
...
Route::group(['middleware' => ['auth','checkRole:customer']],function(){
    ...
    Route::get('/order/suksesCOD','user\OrderController@suksesCOD')->name('user.order.suksesCOD');
