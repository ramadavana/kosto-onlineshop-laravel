            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <h2 class="text-center">Kost Pak Toto</h2>
                </div>
                <h4 style="text-align: center">Belum punya akun?</h4>
                <h6 class="font-weight-light text-center">Daftar Disini</h6>
                ...
                @enderror
                  ...
                  <div class="text-center mt-4 font-weight-light"> Udah Punya Akun? <a href="/login" class="text-primary">Masuk</a>
                  </div>
                </form>
              </div>
            </div>
