...
<div class="site-section">
    ...
    <h2 class="display-3 text-black mb-3" style="margin-left: 25%">Detail Pemesanan</h2>
        ...
        <p class="lead mb-5">Pesanan Kamu Berhasil Dibuat Dengan No Invoice<br>Harap menunjukkan No Invoice dan kartu identitas (KTP/SIM) saat pengambilan kunci kamar kost.</p>
