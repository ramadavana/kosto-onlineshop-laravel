...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/jpg" href="/image/ptt.jpg">
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo"><img src="{{ asset('adminassets') }}/assets/images/ptt.jpg" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini"><img src="{{ asset('adminassets') }}/assets/images/ptt.jpg" alt="logo" /></a>
        </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.product') }}">
                <span class="menu-title">Atur Kamar</span>
                <i class="mdi mdi mdi-sleep menu-icon"></i>
              </a>
            </li>
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.perludicek') }}">Cek Pesanan</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.konfirm') }}">Konfirmasi Ambil Kunci</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.dikirim') }}">Ambil Kunci</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.selesai') }}">Pesanan Selesai</a></li>
